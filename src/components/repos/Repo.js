...
function Repo({name, stars, forks, size, description, language}) {
	return (
		<RepoStyled langColors={langColors} language={language}>
			<a href="">
			<div className="name">
				<svg aria-hidden="true" classname="octicon" height="16" role="img" viewBox="0 0 12 16" width="12" style={{display: "inline-block", fill: 'currentcolor', userSelect: 'none', verticalAlign: 'text-bottom'}}><path fill-rule="evenodd" d="M4 9H3V8h1v1zm0-3H3v1h1V6zm0-2H3v1h1V4zm0-2H3v1h1V2zm8-1v12c0 .55-.45 1-1 1H6v2l-1.5-1.5L3 16v-2H1c-.55 0-1-.45-1-1V1c0-.55.45-1 1-1h10c.55 0 1 .45 1 1zm-1 10H1v2h2v-1h3v1h5v-2zm0-10H2v9h9V1z"></path></svg>
				<h5>{name}</h5>
			</div>
			...
			<div className="footer-repo">
				...
				<span className="forks-repo">
					<svg aria-hidden="true" class="octicon" height="16" role="img" viewBox="0 0 10 16" width="10" style={{display: "inline-block", fill: "#6a737d", userSelect: "none", verticalAlign: "text-bottom"}}><path fill-rule="evenodd" d="M8 1a1.993 1.993 0 0 0-1 3.72V6L5 8 3 6V4.72A1.993 1.993 0 0 0 2 1a1.993 1.993 0 0 0-1 3.72V6.5l3 3v1.78A1.993 1.993 0 0 0 5 15a1.993 1.993 0 0 0 1-3.72V9.5l3-3V4.72A1.993 1.993 0 0 0 8 1zM2 4.2C1.34 4.2.8 3.65.8 3c0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3 10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3-10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2z"></path></svg>
					<p>{forks}</p>
				</span>
				</div>
